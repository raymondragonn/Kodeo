...
import aramondraCover from '../assets/projects/aramondra/aramondra-mockup-cover.png?format=webp&width=800&quality=82';
...
export default function ServicePage({ copy, service, motionSpeed = 1, onBack, onNavItemClick, onContact, onNavigate, onServiceClick, onExtrasClick }) {
